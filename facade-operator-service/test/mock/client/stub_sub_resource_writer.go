...
//
//	mockgen --destination=./client/stub_sub_resource_writer.go --package=mock_client --build_flags=--mod=mod sigs.k8s.io/controller-runtime/pkg/client SubResourceWriter
//
