...
require (
	...
	github.com/netcracker/qubership-core-lib-go-actuator-common/v2 v2.3.0 // indirect
...
// replace github.com/netcracker/qubership-core-lib-go/v3 => ../../qubership-core-lib-go
