...
require (
	...
	github.com/netcracker/qubership-core-lib-go-fiber-server-utils/v2 v2.6.2
...
require (
	...
	github.com/netcracker/qubership-core-lib-go-actuator-common/v2 v2.7.2 // indirect
